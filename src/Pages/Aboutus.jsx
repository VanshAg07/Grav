    ...
    <>
      ...
      <div className="flex flex-wrap items-start justify-between bg-white py-10 px-6 lg:px-16">
        ...
        <div className="w-full lg:w-1/2 mb-8 lg:mb-0 px-4 lg:pl-12">
          <h1 className="text-3xl lg:text-4xl font-bold text-[#002379] mb-4">
            Overview
          </h1>
          <p className="text-black text-base lg:text-lg mb-6">
          ...
          <div className="bg-gray-100 p-6 shadow rounded-md transition-all duration-300 ease-in-out">
            ...
            <button
              ...
              className="text-[#002379] flex items-center mt-4 hover:underline"
            >
      ...
      <div className=" w-[90vw] mx-auto text-white px-8 py-12">
        ...
        <div className="flex flex-wrap lg:flex-nowrap items-start justify-between space-y-8 lg:space-y-0 lg:space-x-8">
          ...
          <div className="w-full lg:w-1/2 bg-blue-900 p-8 rounded-lg shadow-md">
            <div className="flex items-center justify-center space-x-16 pb-2">
              <h2 className="text-4xl -mb-4 font-bold">Mission</h2>
              <img src={img5} alt="contact" className="h-16 object-cover" />
            </div>
          ...
          <div className="w-full lg:w-1/2 bg-blue-900 p-8 rounded-lg shadow-md">
            ...
            <img src={img3} alt="contact" className="h-36 object-cover" />
          </div>
        </div>

        {/* Values Section */}
        <div className="bg-[#002379] mx-auto flex flex-col lg:flex-row p-8 mt-12 rounded-lg max-w-7xl">
          {/* Left Section */}
          <div className="flex flex-col items-center lg:items-start lg:w-1/2 mb-8 lg:mb-0">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-center lg:text-left text-white">
              Values
            </h2>
            ...
            <img
              src={img4}
              alt="contact"
              className="h-40 w-full lg:w-auto object-cover rounded-md"
            />
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 space-y-4">
            <p className="text-base lg:text-lg text-white">
              <span className="font-semibold">Fairness</span> is key to our
              business practices. We believe in conducting our operations fairly
              and ethically, ensuring all stakeholders are treated equitably.
            </p>
            <p className="text-base lg:text-lg text-white">
              <span className="font-semibold">Trust</span> is the foundation of
              our relationships with our stakeholders. We value the trust that
              our stakeholders have placed in us and work tirelessly to maintain
              and strengthen it.
            </p>
            <p className="text-base lg:text-lg text-white">
              <span className="font-semibold">Respect</span> is an essential
              component of our culture. We treat all our stakeholders equally,
              regardless of their background, position, or status.
            </p>
            <p className="text-base lg:text-lg text-white">
              <span className="font-semibold">Passion</span> is what drives us
              to succeed. We are passionate about recycling and creating a
